...
app does plenty of so it would be nice if we could abstract that away into a
custom hook and make use of elsewhere.
...
page. In that case, the component would get removed from the page ("unmounted")
and when the request finally does complete, it will call `dispatch`, but because
the component has been removed from the page, we'll get this warning from React:
...
<a rel="noopener noreferrer" target="_blank" href="https://ws.kcd.im/?ws=Advanced%20React%20Hooks%20%F0%9F%94%A5&e=02%3A%20useCallback%3A%20custom%20hooks&em=evans.musomi@gmail.com">
